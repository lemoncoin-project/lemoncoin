...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars LEMONCOIND and LEMONCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

BITCOIND=${LEMONCOIND:-${1}/lemoncoind}
CLI=${LEMONCOINCLI:-${1}/lemoncoin-cli}
