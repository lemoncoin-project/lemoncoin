...
// LemonCoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateLemonCoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 525,000 blocks which will occur approximately once every year.
    nSubsidy >>= halvings;
    if (nHeight == 1)
