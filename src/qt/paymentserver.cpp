...
const char* BIP71_MIMETYPE_PAYMENT = "application/lemoncoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lemoncoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lemoncoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start lemoncoin: click-to-pay handler"));
        }
        else {
