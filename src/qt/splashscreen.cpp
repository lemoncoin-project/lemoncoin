    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("LemonCoin Core");
    ...
    QString copyrightTextLemon  = QChar(0xA9)+QString(" 2016-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The LemonCoin developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceDoge,copyrightTextLemon);
