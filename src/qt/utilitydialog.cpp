    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LemonCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About LemonCoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LemonCoin Core is shutting down...") + "<br /><br />" +
