...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MLEMON");
    case kBTC: return QString("kLEMON");
    case BTC: return QString("LEMON");
    case mBTC: return QString("mLEMON");
    case uBTC: return QChar(0x03BC) + QString("LEMON");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-LemonCoins (1,000,000)");
    case kBTC: return tr("Kilo-LemonCoins (1,000)");
    case BTC: return tr("LemonCoins");
    case mBTC: return tr("Milli-LemonCoins (1 / 1,000)");
    case uBTC: return tr("Micro-LemonCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
