...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("LemonCoin Core lemoncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lemoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lemoncoin transaction") + "\n" +
              "  lemoncoin-tx [options] -create [commands]   " + _("Create hex-encoded lemoncoin transaction") + "\n" +
              "\n";
