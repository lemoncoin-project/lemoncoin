...
/*
 * MMXVI instance: memory pointer, number of passes, amount of memory, type,
 * and derived values.
...
/*
 * MMXVI position: where we construct the block right now. Used to distribute
 ...
 * @param  context  Pointer to the MMXVI internal structure containing memory
 ...
 * @param  context  Pointer to the MMXVI internal structure containing memory
 * pointer, and parameters for time and space requirements.
 * @param  instance Current MMXVI instance
 ...
 * the memory.
 * @param context Pointer to current MMXVI context (use only the out parameters
 * from it)
 * @param instance Pointer to current instance of MMXVI
 ...
 * @param  context  Pointer to the MMXVI internal structure
