...
static void usage(const char *cmd) {
    ...
    printf("\t-d\t\tUse MMXVId instead of Argon2i (which is the default)\n");
...
/*
Runs MMXVI with certain inputs and parameters, inputs not cleared. Prints the
