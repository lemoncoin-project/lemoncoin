...
/* MMXVI external data structures */

/*
 *****Context: structure to hold MMXVI inputs:
 ...
 ****************************
 ...
 You need to spend 1 GB of RAM and you run 5 passes of MMXVId with 4 parallel
 lanes.
...
/*
 * **************MMXVId: Version of MMXVI that picks memory blocks depending
 * on the password and salt. Only for side-channel-free
 * environment!!***************
 * @param  context  Pointer to current MMXVI context
 * @return  Zero if successful, a non zero error code otherwise
 */
int argon2d(argon2_context *context);

/*
 *  * **************Argon2i: Version of MMXVI that picks memory blocks
...
/*
 *   * **************Argon2ds: MMXVId hardened against GPU attacks, 20%
 * slower***************
 * @param  context  Pointer to current MMXVI context
 * @return  Zero if successful, a non zero error code otherwise
 */
...
/*
 * Verify if a given password is correct for MMXVId hashing
 * @param  context  Pointer to current MMXVI context
