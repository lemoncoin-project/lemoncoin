...
static const string strSecret1     ("6v8Nqgn8spzWjTpPN64w7A55kHWTKpjjY2kvY8baaJsUnfLYJ53");
static const string strSecret2     ("6ushGfEtSLRUV3gBzxALk19QSVb95vMygK9vqtYceRZ1zcdhfxA");
static const string strSecret1C    ("T7VZPtaDmLprERN9i5NMpB31x3s1C5hcjxksJQXdC1soeStCLjyM");
static const string strSecret2C    ("T6Nkk7nJ2pj2JnoyYnUE8oe6TXBggiXbAX8QenWYLBNKNvyfHzS1");
static const CBitcoinAddress addr1 ("LaFtx1wAPXbThMRyJgP2pUBUGc4s2Rub4M");
static const CBitcoinAddress addr2 ("LQygcBZEaXsYpmL9JHdhczU3sWnFXwzn9A");
static const CBitcoinAddress addr1C("LVxbySgskoSFjqwHyqDJUzocJQQMatqXes");
static const CBitcoinAddress addr2C("LURjxRNyfNxgroca7Y5ng4R4gAStwTtDzn");
...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    for (int n=0; n<16; n++)
    {
        string strMsg = strprintf("Secret message %i: 11", n);
    ...
    string strMsg = "Deterministic message";
    uint256 hashMsg = Hash(strMsg.begin(), strMsg.end());
    BOOST_CHECK(key1.Sign(hashMsg, detsig));
    BOOST_CHECK(key1C.Sign(hashMsg, detsigc));
    BOOST_CHECK(detsig == detsigc);
    BOOST_CHECK(detsig == ParseHex("da60a3ec73621a60e8db243e7febb883ea78377492d8db16f59790f7458d0cfb0e65aad55b83d20cfd8d5d2c4da808a8cc8fd33038a82c5845e85aaa90d92624"));
